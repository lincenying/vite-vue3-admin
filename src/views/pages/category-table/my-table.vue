<template>
    <div class="layout-container">
        ...
        <div class="layout-container-table">
            <layoutTable v-model:page="page" v-loading="loading" :show-index="true" :show-selection="true" :data="tableData" @get-table-data="getTableData" @selection-change="handleSelectionChange">
            ...
            <dialogModify v-if="layer.show" :layer="layer" @update="(payload) => (layer.show = payload)" @get-table-data="getTableData" />
        </div>
    </div>
</template>

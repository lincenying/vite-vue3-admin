<template>
    <div class="tabs">
        ...
        <div class="handle">
            <div id="vueAdminBoxTabRefresh" @click="pageReload" />
            <div id="vueAdminBoxTabCloseSelf" @click="closeCurrentRoute" />
            <div id="vueAdminBoxTabCloseOther" @click="closeOtherRoute" />
            <div id="vueAdminBoxTabCloseAll" @click="closeAllRoute" />
